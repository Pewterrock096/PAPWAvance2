                      ...
                      <div class="card-header">
                       ...
                       <div class="card-body">
                           ...
                           <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" id="descripcionarticulo"></textarea>
                              </div>
                           <div class="form-group">
                                <label for="categoriaarticulo"> Categoría:</label>
                                <select class="form-control" id="categoriarticulo">
                           ...
                           <div class="form-group">
                                ...
                                <select class="form-control" id="categoriarticulo2">
                                    <option>Tecnología</option>
                                    <option>Vehículos</option>
                                    <option>Hogar</option>
                                    <option>Juguetes</option>
                           ...
                           <div class="form-group">
                                ...
                                <select class="form-control" id="categoriarticulo3">
                                    <option>Tecnología</option>
                                    <option>Vehículos</option>
                                    <option>Hogar</option>
                                    <option>Juguetes</option>
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="unidadesarticulo">
                              </div>
                            <div class="form-goup">
                           ...
                           <div class="form-goup">
                                            ...
                                            <input type="file" class="col-7" name="fotoarticulo" id="fotoarticulo2">
                                            
                            </div>
                           <div class="form-goup">
                                            
                                            <label for="fotoarticulo3"> Foto del Artículo: </label>
                                            <input type="file" class="col-7" name="fotoarticulo" id="fotoarticulo3">
                       ...
                       <div class="card-footer">
                           ...
                           <button type="button" class="btn btn-info">Publicar Artículo</button>
                               </div>
                           </div>
                       </div>
                    </div>
